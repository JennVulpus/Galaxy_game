...
class MainWidget(RelativeLayout):
    ...
    def init_audio(self):
        ...
        self.sound_begin.volume = .13
        self.galaxy.volume = .13
        self.gameover_voice.volume = .13
        self.gameover_impact.volume = .3
        self.music1.volume = .5
        self.restart.volume = .13
    ...
    def update_horizontal_lines(self):
        ...
        for i in range(start_index, start_index + self.H_NB_LINES):
